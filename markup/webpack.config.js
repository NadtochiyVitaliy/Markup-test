        ...
        use: [
          {
            ...
            options: {
              ...
              publicPath: function (url) {
                ...
                const isInc = url.includes(config.static.inc.src);
                ...
                const incOutput = config.static.inc.dest ? config.static.inc.dest : config.static.inc.src;
                ...
                if (isFonts) {
                  ...
                  return getStaticAssetOutputPath({
                    assets: config.static.inc,
                    outputFolder: incOutput,
                    parsedUrlPath: parsedPath,
                    stylesDest: dest,
                  });
                } else {
